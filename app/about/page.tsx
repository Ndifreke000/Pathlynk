...
export default function AboutPage() {
  const stats = [
    { icon: Users, value: "2,500+", label: "Successful Migrations" },
  ...
  const team = [
    {
      ...
      role: "Founder & CEO",
      background: "Former NHS Administrator, migrated from Lagos to London in 2019",
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-muted-foreground leading-relaxed">
              ...
              guidance and building a supportive community of successful migrants who help others achieve their dreams.
            </p>
          </CardContent>
        </Card>
      ...
      <Card className="mb-16">
        ...
        <CardContent className="prose prose-gray dark:prose-invert max-w-none">
          <p className="text-muted-foreground leading-relaxed mb-4">
            Pathlynk was born from personal experience. Our founder, Adebayo, spent months navigating the complex UK job
            application process in 2019, facing countless rejections and confusion about visa requirements, CV
            formatting, and interview processes.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-4">
            After successfully securing an NHS position and helping friends and family do the same, Adebayo realized
            there was a massive information gap. Talented Nigerians were struggling not because they lacked skills, but
            because they lacked the right guidance and support system.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Today, Pathlynk has helped over 2,500 Nigerians secure jobs across the UK, from NHS hospitals in London to
            tech companies in Manchester. We've built more than a platform - we've created a movement of mutual support
            and shared success.
          </p>
        </CardContent>
      </Card>
