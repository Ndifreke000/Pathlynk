...
export default function HowItWorksPage() {
  const steps = [
    ...
    },
    {
      ...
      description: "Discover NHS roles, skilled worker positions, care sector opportunities, and more.",
      details: [
  ...
  const successMetrics = [
    { icon: Target, value: "96%", label: "Success Rate", description: "Of active members secure UK jobs" },
    ...
    { icon: Users, value: "2,500+", label: "Success Stories", description: "Nigerians now working in UK" },
  ]

  const pathways = [
    {
      title: "NHS Healthcare Route",
