...
export default function ContactPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Based on our success stories, most members secure UK job offers within 6-12 months. The timeline depends on your sector (NHS applications typically take 8-10 months, care sector 4-6 months, skilled worker roles 6-8 months), qualifications, and how actively you apply our guidance.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes! Many UK employers offer visa sponsorship, especially in healthcare, care sector, and skilled worker roles. We maintain a database of sponsor-licensed employers and guide you on how to identify and apply to companies that can sponsor your visa.",
    },
    {
      question: "Is IELTS mandatory for all UK jobs?",
      answer:
        "IELTS is required for visa applications and most professional roles. Minimum scores vary: NHS roles typically require 7.0 overall, care sector roles 6.5, and skilled worker roles 6.0. We provide comprehensive IELTS preparation materials to help you achieve required scores.",
    },
    {
      ...
      <Card className="mt-12 bg-gradient-to-r from-emerald-600 to-teal-600 text-white border-0">
        <CardContent className="p-8 text-center">
          ...
          <p className="text-emerald-100 mb-6 max-w-2xl mx-auto">
            Join our community of 2,500+ members and get answers from people who've successfully made the journey to the
            UK.
          </p>
